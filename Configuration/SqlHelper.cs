...
namespace Configuration
{
    ...
    public sealed class SqlHelper
    {
        ...
        public static int ExecuteNonQueryTimeOut(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                // Call the overload that takes a connection in place of the connection string
                return ExecuteNonQueryTimeOut(connection, commandType, commandText, commandParameters);
            }
        }
        ...
        public static int ExecuteNonQueryTimeOut(SqlConnection connection, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            if (connection == null) throw new ArgumentNullException("connection");
        ...
        /// 
        //andy vera
        public static DataSet ExecuteDatasetTimeOut(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                // Call the overload that takes a connection in place of the connection string
                return ExecuteDatasetTimeOut(connection, commandType, commandText, commandParameters);
            }
        }
        ...
        /// <returns>A dataset containing the resultset generated by the command</returns>
        /// 
        public static DataSet ExecuteDatasetTimeOut(SqlConnection connection, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            if (connection == null) throw new ArgumentNullException("connection");
